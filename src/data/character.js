export const Character = {
    model: {
        ...
        sanity: { key: 'sanity', default: 150, max: true, tip:"Your character goes insane and will likely die when this reaches 0. Lose 1 dice from your Mind Pool per 10 sanity lost."},
        fatigue: { key: 'fatigue', tip:"Measure of exhaustion - each point of fatigue increases the dice face used for all rolls by 1, which reduces the chance of getting a success."},
