...
var funcs = {
    ...
    searchProperty: function(prop, val, location = null){
        ...
        if (location != null && location in this.data){
            loc = this.data[location];
        } else {
            loc = this.data;
        }

        found = recursiveSearch(prop, val, loc);
...
exports.defaultContext = new FunkContext('./data', funcs, reusables);
exports.defaultFuncs = funcs;
exports.reusables = reusables;
